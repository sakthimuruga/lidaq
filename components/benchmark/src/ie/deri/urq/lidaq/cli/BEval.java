...
import ie.deri.urq.lidq.benchmark.eval.BenchmarkEval1;
 ...
 * @date Sep 17, 2010
 */
public class BEval extends CLIObject {
	private static final Logger logger = Logger.getLogger(BEval.class.getName());
	...
	protected void execute(CommandLine cmd) {
			...
			BenchmarkEval1 eval = new BenchmarkEval1();
